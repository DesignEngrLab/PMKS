...
namespace StarMathLib
{
    internal static partial class StarMath
    {
        ...
        /// <returns></returns>
        internal static double[] solve(double[,] A, IList<double> b)
        {
        ...
        /// <param name="b">The b.</param>
        /// <returns></returns>
        internal static double[] solve(int[,] A, IList<double> b)
        {
            if (A.GetLength(0) != A.GetLength(1))
                throw new Exception("Matrix, A, must be square.");
            if (A.GetLength(0) != b.Count)
        ...
        /// <param name="b">The b.</param>
        /// <returns></returns>
        internal static double[] solve(double[,] A, IList<int> b)
        {
            if (A.GetLength(0) != A.GetLength(1))
                throw new Exception("Matrix, A, must be square.");
            if (A.GetLength(0) != b.Count)
        ...
        /// <param name="b">The b.</param>
        /// <returns></returns>
        internal static double[] solve(int[,] A, IList<int> b)
        {
            if (A.GetLength(0) != A.GetLength(1))
                throw new Exception("Matrix, A, must be square.");
            if (A.GetLength(0) != b.Count)
