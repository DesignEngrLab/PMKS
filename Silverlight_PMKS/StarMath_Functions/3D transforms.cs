...
namespace StarMathLib
{
    internal static partial class StarMath
    {
        ...
        internal static double[,] Translate(double Tx, double Ty, double Tz)
        {
        ...
        internal static double[,] RotationX(double xdeg)
        {
        ...
        /// <returns>4-by-4 matrix rotated by the amount specified.</returns>
        internal static double[,] RotationY(double ydeg)
        {
        ...
        /// <returns>4-by-4 matrix rotated by the amount specified.</returns>
        internal static double[,] RotationZ(double zdeg)
        {
