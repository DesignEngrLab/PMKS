...
namespace StarMathLib
{
    internal static partial class StarMath
    {
        ...
        internal static string MakePrintString(double[,] A)
        {
        ...
        /// </summary>
        /// <param name = "A">The A.</param>
        internal static string MakePrintString(IList<double> A)
        {
            if (A == null) return "<null>";
            var format = "{0:F" + numDecimals + "}";
            var p = "{ ";
        ...
        /// </summary>
        /// <param name = "A">The A.</param>
        internal static string MakePrintString(int[,] A)
        {
            if (A == null) return "<null>";
        ...
        /// </summary>
        /// <param name = "A">The A.</param>
        internal static string MakePrintString(IList<int> A)
        {
            if (A == null) return "<null>";
            const string format = "{0}";
            var p = "{ ";
