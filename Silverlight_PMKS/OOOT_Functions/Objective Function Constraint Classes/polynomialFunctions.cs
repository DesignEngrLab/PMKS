...
namespace OptimizationToolbox
{
    ...
    public static class polynomialHelper
    {
        ...
        public static string convert(double[] term)
        {
            var sTerm = "";
        ...
        public static double[] convert(string sTerm)
        {
        ...
        public static List<double[]> convert(List<string> sTerms)
        {
        ...
        public static List<string> convert(List<double[]> terms)
        {
            return new List<string>(terms.Select(convert));
        }

        public static List<double[]> convert(double[,] matrixOfTerms)
        {
        ...
        public static double calculateTerm(double[] x, double[] term)
        {
        ...
        public static double calculateDeriv(double[] x, double[] term, int position)
        {
            /* the first term is always the coefficient. We can start the product with that. */
