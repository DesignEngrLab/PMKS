...
namespace OptimizationToolbox
{
    public class MaxAgeConvergence : abstractConvergence
    {
        ...
        /// <summary>
        /// Gets or sets the tolerance for same candidate (used to increment the public age of best).
        /// </summary>
        ...
        /// <summary>
        /// publicly keeps track of the age of the best candidate. If it exceeds the given MaxAge value, 
