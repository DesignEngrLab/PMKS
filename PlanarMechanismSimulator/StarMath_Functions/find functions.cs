...
namespace StarMathLib
{
    internal static partial class StarMath
    {
        ...
        /// the maximum value 
        /// </returns>
        internal static double Max(double[,] A, out int rowIndex, out int colIndex)
        {
            var max = Max(A);
        ...
        /// the maximum value 
        /// </returns>
        internal static int Max(int[,] A, out int rowIndex, out int colIndex)
        {
            var max = Max(A);
            rowIndex = A.GetLength(0);
            colIndex = -1;
        ...
        /// the minimum value.
        /// </returns>
        internal static double Min(double[,] A, out int rowIndex, out int colIndex)
        {
            var min = Min(A);
            rowIndex = A.GetLength(0);
            colIndex = -1;
        ...
        /// the minimum value.
        /// </returns>
        internal static int Min(int[,] A, out int rowIndex, out int colIndex)
        {
            var min = Min(A);
            rowIndex = A.GetLength(0);
            colIndex = -1;
        ...
        /// <param name = "A">The array to be searched for</param>
        /// <returns>An integer value that is the maximum of A</returns>
        internal static int Max(IList<int> A)
        {
            return A.Max();
        }
        /// <summary>
        ...
        /// <param name = "A">The array to be searched for</param>
        /// <returns>An integer value that is the minimum of A</returns>
        internal static int Min(IList<int> A)
        {
            return A.Min();
        }
        /// <summary>
        ...
        internal static double Max(IList<double> A)
        {
            return A.Max();
        }
        /// <summary>
        ...
        internal static double Min(IList<double> A)
        {
            return A.Min();
        }
        ...
        /// the minimum value 
        /// </returns>
        internal static double Min(IList<double> A, out int index)
        {
            var min = A.Min();
            index = A.IndexOf(min);
            return min;
        ...
        /// the maximum value
        /// </returns>
        internal static double Max(IList<double> A, out int index)
        {
            var max = A.Max();
            index = A.IndexOf(max);
            return max;
        ...
        /// the minimum value 
        /// </returns>
        internal static int Min(IList<int> A, out int index)
        {
            var min = A.Min();
            index = A.IndexOf(min);
            return min;
        ...
        /// the maximum value
        /// </returns>
        internal static int Max(IList<int> A, out int index)
        {
            var max = A.Max();
            index = A.IndexOf(max);
            return max;
        ...
        /// <returns></returns>
        internal static IList<int> find(double FindVal, IList<double> A)
        {
        ...
        /// <param name = "A">The A.</param>
        /// <returns></returns>
        internal static IList<int> find(int FindVal, IList<int> A)
        {
            return A.Select((value, index) => new { Item = value, Position = index })
                .Where(x => x.Item == FindVal).Select(a => a.Position).ToList();
        }
        ...
        /// <param name="A">The A.</param>
        /// <returns></returns>
        internal static int[] find(double FindVal, double[,] A)
        {
        ...
        /// <param name="A">The A.</param>
        /// <returns></returns>
        internal static int[] find(int FindVal, int[,] A)
        {
            var rowIndex = A.GetLength(0);
            while (--rowIndex >= 0)
                if (GetRow(rowIndex, A).Contains(FindVal))
