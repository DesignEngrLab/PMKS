...
namespace StarMathLib
{
    ...
    internal static partial class StarMath
    {
        ...
        internal static double[,] makeZero(int p)
        {
        ...
        internal static int[,] makeZeroInt(int p)
        {
            if (p <= 0) throw new Exception("The size, p, must be a positive integer.");
            return new int[p, p];
        }
        ...
        /// <returns></returns>
        internal static double[] makeZeroVector(int p)
        {
            if (p <= 0) throw new Exception("The size, p, must be a positive integer.");
            return new double[p];
        }
        ...
        /// <param name = "p">The p.</param>
        /// <returns></returns>
        internal static int[] makeZeroIntVector(int p)
        {
            if (p <= 0) throw new Exception("The size, p, must be a positive integer.");
            return new int[p];
        }
        ...
        internal static double[,] makeZero(int numRows, int numCols)
        {
        ...
        /// <param name = "numCols">The number of columns.</param>
        /// <returns>an empty (all zeroes) matrix.</returns>
        internal static int[,] makeZeroInt(int numRows, int numCols)
        {
            if (numRows <= 0) throw new Exception("The number of rows, numRows, must be a positive integer.");
            if (numCols <= 0) throw new Exception("The number of columns, numCols, must be a positive integer.");
        ...
        internal static double[,] makeIdentity(int p)
        {
            if (p <= 0) throw new Exception("The size, p, must be a positive integer.");
        ...
        /// <param name = "p">The size (number of both rows and columns).</param>
        /// <returns>the identity matrix, I.</returns>
        internal static int[,] makeIdentityInt(int p)
        {
            if (p <= 0) throw new Exception("The size, p, must be a positive integer.");
            var I = new int[p, p];
            for (var i = 0; i < p; i++)
        ...
        /// </returns>
        internal static double[] makeLinearProgression(double end, double interval, double start = 0.0)
        {
        ...
        /// with a distance of the interval between any pair of numbers.
        /// </returns>
        internal static int[] makeLinearProgression(int end, int interval, int start = 0)
        {
        ...
        /// with a distance of the interval between any pair of numbers.
        /// </returns>
        internal static double[] makeLinearProgression(double end, int numElements, double start = 0.0)
        {
        ...
        internal static double[] GetColumn(int colIndex, double[,] A)
        {
        ...
        /// <param name = "A">The matrix, A.</param>
        /// <returns>A double array that contains the requested column</returns>
        internal static int[] GetColumn(int colIndex, int[,] A)
        {
            var numRows = A.GetLength(0);
            var numCols = A.GetLength(1);
            if ((colIndex < 0) || (colIndex >= numCols))
        ...
        internal static double[] GetRow(int rowIndex, double[,] A)
        {
            var numRows = A.GetLength(0);
            var numCols = A.GetLength(1);
        ...
        /// <param name = "A">The matrix, A.</param>
        /// <returns>A double array that contains the requested row</returns>
        internal static int[] GetRow(int rowIndex, int[,] A)
        {
            var numRows = A.GetLength(0);
            var numCols = A.GetLength(1);
            if ((rowIndex < 0) || (rowIndex >= numRows))
        ...
        internal static void SetRow(int rowIndex, double[,] A, IList<double> v)
        {
            var numRows = A.GetLength(0);
            var numCols = A.GetLength(1);
            if ((rowIndex < 0) || (rowIndex >= numRows))
        ...
        /// <param name = "A">The matrix, A.</param>
        /// <param name = "v">The vector, v.</param>
        internal static void SetRow(int rowIndex, int[,] A, IList<int> v)
        {
            var numRows = A.GetLength(0);
            var numCols = A.GetLength(1);
            if ((rowIndex < 0) || (rowIndex >= numRows))
        ...
        internal static void SetColumn(int colIndex, double[,] A, IList<double> v)
        {
            var numRows = A.GetLength(0);
            var numCols = A.GetLength(1);
            if ((colIndex < 0) || (colIndex >= numCols))
        ...
        /// <param name = "A">The A.</param>
        /// <param name = "v">The v.</param>
        internal static void SetColumn(int colIndex, int[,] A, IList<int> v)
        {
            var numRows = A.GetLength(0);
            var numCols = A.GetLength(1);
            if ((colIndex < 0) || (colIndex >= numCols))
        ...
        internal static double[,] GetColumns(IList<int> ColumnList, double[,] A)
        {
        ...
        internal static int[,] GetColumns(IList<int> ColumnList, int[,] A)
        {
        ...
        internal static double[,] GetRows(IList<int> RowList, double[,] A)
        {
        ...
        internal static int[,] GetRows(IList<int> RowList, int[,] A)
        {
        ...
        internal static double[] GetColumns(IList<int> ColumnList, IList<double> A)
        {
        ...
        internal static int[] GetColumns(IList<int> ColumnList, IList<int> A)
        {
        ...
        internal static double[] JoinVectors(IList<double> Array1, IList<double> Array2)
        ...
        internal static int[] JoinVectors(IList<int> Array1, IList<int> Array2)
        { return JoinVectors(Array1, Array2, Array1.Count, Array2.Count); }
        /// <summary>
        /// Concatenates two 1D integer arrays and returns the result. The given variables remain unchanged
        /// </summary>
        ...
        /// <returns></returns>
        internal static double[] JoinMatrixColumnsIntoVector(double[,] A)
        ...
        /// <param name="numCols">The number of columns.</param>
        /// <returns></returns>
        internal static double[] JoinMatrixColumnsIntoVector(double[,] A, int numRows, int numCols)
        {
        ...
        /// <returns></returns>
        internal static int[] JoinMatrixColumnsIntoVector(int[,] A)
        { return JoinMatrixColumnsIntoVector(A, A.GetLength(0), A.GetLength(1)); }
        /// <summary>
        /// Joins the matrix columns into vector.
        /// </summary>
        ...
        /// <param name="numCols">The number of columns.</param>
        /// <returns></returns>
        internal static int[] JoinMatrixColumnsIntoVector(int[,] A, int numRows, int numCols)
        {
        ...
        /// <param name="A">The matrix of doubles, A.</param>
        /// <returns></returns>
        internal static double[] JoinMatrixRowsIntoVector(double[,] A)
        ...
        /// <param name="numCols">The number of columns.</param>
        /// <returns></returns>
        internal static double[] JoinMatrixRowsIntoVector(double[,] A, int numRows, int numCols)
        {
            var B = new double[numRows * numCols];
            for (var i = 0; i < numRows; i++)
        ...
        /// <param name="A">The matrix of integers, A.</param>
        /// <returns></returns>
        internal static int[] JoinMatrixRowsIntoVector(int[,] A)
        { return JoinMatrixRowsIntoVector(A, A.GetLength(0), A.GetLength(1)); }
        /// <summary>
        /// Joins the matrix rows into vector.
        /// </summary>
        ...
        /// <param name="numCols">The number of columns.</param>
        /// <returns></returns>
        internal static int[] JoinMatrixRowsIntoVector(int[,] A, int numRows, int numCols)
        {
            var B = new int[numRows * numCols];
            for (var i = 0; i < numRows; i++)
                GetRow(i, A).CopyTo(B, i * numCols);
