...
namespace StarMathLib
{
    internal static partial class StarMath
    {
        ...
        /// <param name = "a">The double value to be divided by, the divisor.</param>
        /// <returns>A 1D double array that contains the product</returns>
        internal static double[] divide(IList<int> B, double a)
        { return multiply((1 / a), B); }
        /// <summary>
        /// Divides all elements of a 1D integer array by the double value.
        /// </summary>
        ...
        /// A 1D double array that contains the product
        /// </returns>
        internal static double[] divide(IList<int> B, double a, int length)
        { return multiply((1 / a), B, length); }
        #endregion
        ...
        /// <param name = "a">The double value to be divided by, the divisor.</param>
        /// <returns>A 2D double array that contains the product</returns>
        internal static double[,] divide(double[,] B, double a)
        { return multiply((1 / a), B); }
        /// <summary>
        /// Divides all elements of a 2D double array by the double value.
        /// </summary>
        ...
        /// A 2D double array that contains the product
        /// </returns>
        internal static double[,] divide(double[,] B, double a, int numRows, int numCols)
        ...
        /// <param name = "a">The double value to be divided by, the divisor.</param>
        /// <returns>A 2D double array that contains the product</returns>
        internal static double[,] divide(int[,] B, double a)
        { return multiply((1 / a), B); }
        ...
        /// A 2D double array that contains the product
        /// </returns>
        internal static double[,] divide(int[,] B, double a, int numRows, int numCols)
        { return multiply((1 / a), B, numRows, numCols); }
        #endregion
        ...
        /// <param name = "B">1D double Array, B</param>
        /// <returns>A double value that contains the dot product</returns>
        internal static double dotProduct(IList<int> A, IList<double> B)
        {
            var length = A.Count();
            if (length != B.Count())
                throw new Exception("Matrix sizes do not match");
        ...
        /// A double value that contains the dot product
        /// </returns>
        internal static double dotProduct(IList<int> A, IList<double> B, int length)
        {
            var c = 0.0;
            for (var i = 0; i != length; i++)
                c += A[i] * B[i];
        ...
        /// <returns>A double value that contains the dot product</returns>
        internal static int dotProduct(IList<int> A, IList<int> B)
        {
        ...
        /// A double value that contains the dot product
        /// </returns>
        internal static int dotProduct(IList<int> A, IList<int> B, int length)
        {
            var c = 0;
            for (var i = 0; i != length; i++)
                c += A[i] * B[i];
        ...
        /// <param name = "B">1D double Array, B</param>
        /// <returns>A double value that contains the dot product</returns>
        internal static double[] crossProduct(IList<double> A, IList<double> B)
        {
            var Alength = A.Count();
            var Blength = B.Count();
        ...
        /// <param name = "B">1D double Array, B</param>
        /// <returns>A double value that contains the dot product</returns>
        internal static double[] crossProduct(IList<int> A, IList<double> B)
        {
            var Alength = A.Count();
            var Blength = B.Count();
            if ((Alength == 1) && (Blength == 1))
        ...
        /// <returns>A double value that contains the dot product</returns>
        internal static double[] crossProduct(IList<double> A, IList<int> B)
        {
            var Alength = A.Count();
            var Blength = B.Count();
            if ((Alength == 1) && (Blength == 1))
        ...
        /// <param name = "B">1D integer Array, B</param>
        /// <returns>A double value that contains the dot product</returns>
        internal static int[] crossProduct(IList<int> A, IList<int> B)
        {
            var Alength = A.Count();
            var Blength = B.Count();
            if ((Alength == 1) && (Blength == 1))
        ...
        /// <param name = "B">1D double Array, B</param>
        /// <returns></returns>
        internal static double crossProduct2(IList<int> A, IList<double> B)
        {
            if (((A.Count() == 2) && (B.Count() == 2))
                || ((A.Count() == 3) && (B.Count() == 3) && A[2] == 0.0 && B[2] == 0.0))
                return A[0] * B[1] - B[0] * A[1];
        ...
        /// <param name = "B">1D integer Array, B</param>
        /// <returns></returns>
        internal static double crossProduct2(IList<double> A, IList<int> B)
        {
            if (((A.Count() == 2) && (B.Count() == 2))
                || ((A.Count() == 3) && (B.Count() == 3) && A[2] == 0.0 && B[2] == 0.0))
                return A[0] * B[1] - B[0] * A[1];
        ...
        /// <param name = "B">1D integer Array, B</param>
        /// <returns></returns>
        internal static int crossProduct2(IList<int> A, IList<int> B)
        {
            if (((A.Count() == 2) && (B.Count() == 2))
                || ((A.Count() == 3) && (B.Count() == 3) && A[2] == 0.0 && B[2] == 0.0))
                return A[0] * B[1] - B[0] * A[1];
        ...
        /// <param name = "B">1D double Array, B</param>
        /// <returns></returns>
        internal static double[] crossProduct7(IList<double> A, IList<double> B)
        {
            return new[]
                       {
        ...
        /// <param name = "B">1D double Array, B</param>
        /// <returns></returns>
        internal static double[] crossProduct7(IList<int> A, IList<double> B)
        {
            return new[]
                       {
                           A[1]*B[3] - A[3]*B[1] + A[2]*B[6] - A[6]*B[2] + A[4]*B[5] - A[5]*B[4],
        ...
        /// <param name = "B">1D integer Array, B</param>
        /// <returns></returns>
        internal static double[] crossProduct7(IList<double> A, IList<int> B)
        {
            return new[]
                       {
                           A[1]*B[3] - A[3]*B[1] + A[2]*B[6] - A[6]*B[2] + A[4]*B[5] - A[5]*B[4],
        ...
        /// <param name = "B">1D integer Array, B</param>
        /// <returns></returns>
        internal static int[] crossProduct7(IList<int> A, IList<int> B)
        {
            return new[]
                       {
                           A[1]*B[3] - A[3]*B[1] + A[2]*B[6] - A[6]*B[2] + A[4]*B[5] - A[5]*B[4],
        ...
        /// <param name = "B">1D double Array, B</param>
        /// <returns></returns>
        internal static double[] crossProduct3(IList<double> A, IList<double> B)
        {
            return new[]
                       {
                           A[1]*B[2] - B[1]*A[2],
        ...
        /// <param name = "B">1D double Array, B</param>
        /// <returns></returns>
        internal static double[] crossProduct3(IList<int> A, IList<double> B)
        {
            return new[]
                       {
                           A[1]*B[2] - B[1]*A[2],
        ...
        /// <param name = "B">1D integer Array, B</param>
        /// <returns></returns>
        internal static double[] crossProduct3(IList<double> A, IList<int> B)
        {
            return new[]
                       {
                           A[1]*B[2] - B[1]*A[2],
        ...
        /// <param name = "B">1D integer Array, B</param>
        /// <returns></returns>
        internal static int[] crossProduct3(IList<int> A, IList<int> B)
        {
            return new[]
                       {
                           A[1]*B[2] - B[1]*A[2],
        ...
        /// <param name = "B">1D double array 2</param>
        /// <returns>1D double array that contains sum of vectros A and B</returns>
        internal static double[] add(IList<int> A, IList<double> B)
        {
            var length = A.Count();
            if (length != B.Count()) throw new Exception("Matrix sizes do not match");
            return add(A, B, length);
        ...
        internal static int[] add(IList<int> A, IList<int> B)
        {
            var length = A.Count();
            if (length != B.Count()) throw new Exception("Matrix sizes do not match");
            return add(A, B, length);
        ...
        /// <returns>2D double array that contains sum of vectros A and B</returns>
        internal static double[,] add(int[,] A, double[,] B)
        {
            var numRows = A.GetLength(0);
            var numCols = A.GetLength(1);
            if (numRows != B.GetLength(0))
        ...
        /// <param name="length">The length of the array.</param>
        /// <returns>1D double array that contains sum of vectros A and B</returns>
        internal static double[] add(IList<int> A, IList<double> B, int length)
        {
            var c = new double[length];
            for (var i = 0; i != length; i++)
                c[i] = A[i] + B[i];
        ...
        /// </returns>
        internal static int[] add(IList<int> A, IList<int> B, int length)
        {
            var c = new int[length];
            for (var i = 0; i != length; i++)
                c[i] = A[i] + B[i];
        ...
        /// <param name="numCols">The number of columns.</param>
        /// <returns>2D double array that contains sum of vectros A and B</returns>
        internal static double[,] add(double[,] A, double[,] B, int numRows, int numCols)
        {
            var C = new double[numRows, numCols];
        ...
        /// <param name="numCols">The number of columns.</param>
        /// <returns>2D double array that contains sum of vectros A and B</returns>
        internal static double[,] add(int[,] A, double[,] B, int numRows, int numCols)
        {
            var C = new double[numRows, numCols];
        ...
        /// </returns>
        internal static int[,] add(int[,] A, int[,] B, int numRows, int numCols)
        {
            var C = new int[numRows, numCols];
        ...
        internal static double[] subtract(IList<double> A, IList<double> B)
        {
            var length = A.Count();
            if (length != B.Count())
                throw new Exception("Matrix sizes do not match");
        ...
        /// <param name = "B">The subtrahend vector, B (1D double)</param>
        /// <returns>Returns the difference vector, C (1D double)</returns>
        internal static double[] subtract(IList<int> A, IList<double> B)
        {
            var length = A.Count();
            if (length != B.Count())
                throw new Exception("Matrix sizes do not match");
        ...
        /// <returns>Returns the difference vector, C (1D double)</returns>
        internal static double[] subtract(IList<double> A, IList<int> B)
        {
            var length = A.Count();
            if (length != B.Count())
                throw new Exception("Matrix sizes do not match");
        ...
        internal static int[] subtract(IList<int> A, IList<int> B)
        {
            var length = A.Count();
            if (length != B.Count())
                throw new Exception("Matrix sizes do not match");
        ...
        /// <param name = "B">The subtrahend matrix, B (2D double).</param>
        /// <returns>Returns the difference matrix, C (2D double)</returns>
        internal static double[,] subtract(int[,] A, double[,] B)
        {
            var numRows = A.GetLength(0);
            var numCols = A.GetLength(1);
            if (numRows != B.GetLength(0))
        ...
        /// <returns>Returns the difference matrix, C (2D double)</returns>
        internal static double[,] subtract(double[,] A, int[,] B)
        {
            var numRows = A.GetLength(0);
            var numCols = A.GetLength(1);
            if (numRows != B.GetLength(0))
        ...
        /// <returns>Returns the difference vector, C (1D double)</returns>
        internal static double[] subtract(IList<double> A, IList<double> B, int length)
        {
            var c = new double[length];
            for (var i = 0; i != length; i++)
                c[i] = A[i] - B[i];
        ...
        /// <param name="length">The length of the vectors.</param>
        /// <returns>Returns the difference vector, C (1D double)</returns>
        internal static double[] subtract(IList<int> A, IList<double> B, int length)
        {
            var c = new double[length];
            for (var i = 0; i != length; i++)
                c[i] = A[i] - B[i];
        ...
        /// <param name="length">The length of the vectors.</param>
        /// <returns>Returns the difference vector, C (1D double)</returns>
        internal static double[] subtract(IList<double> A, IList<int> B, int length)
        {
            var c = new double[length];
            for (var i = 0; i != length; i++)
                c[i] = A[i] - B[i];
        ...
        /// </returns>
        internal static int[] subtract(IList<int> A, IList<int> B, int length)
        {
            var c = new int[length];
            for (var i = 0; i != length; i++)
                c[i] = A[i] - B[i];
        ...
        /// <param name="numCols">The number of columns.</param>
        /// <returns>Returns the difference matrix, C (2D double)</returns>
        internal static double[,] subtract(double[,] A, double[,] B, int numRows, int numCols)
        {
            var C = new double[numRows, numCols];
        ...
        /// <param name="numCols">The number of columns.</param>
        /// <returns>Returns the difference matrix, C (2D double)</returns>
        internal static double[,] subtract(int[,] A, double[,] B, int numRows, int numCols)
        {
            var C = new double[numRows, numCols];
        ...
        /// <param name="numCols">The number of columns.</param>
        /// <returns>Returns the difference matrix, C (2D double)</returns>
        internal static double[,] subtract(double[,] A, int[,] B, int numRows, int numCols)
        {
            var C = new double[numRows, numCols];
        ...
        /// </returns>
        internal static int[,] subtract(int[,] A, int[,] B, int numRows, int numCols)
        {
            var C = new int[numRows, numCols];
