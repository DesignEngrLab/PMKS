...
namespace PlanarMechanismSimulator
{
    public partial class Simulator : IDependentAnalysis
    {
        ...
        //        var pivot0 = ((JointMatrixVariableDescriptor) coriolis1[i]).belongsFrom;
        //        var pivot1 = ((JointMatrixVariableDescriptor) coriolis1[i]).belongsTo;
        ...
        //            {
        //                if (((JointMatrixVariableDescriptor) unknowns[j]).belongsTo == pivot0)
        //                    accelerationMatrix[i, j] = 1;
        //                if (((JointMatrixVariableDescriptor) unknowns[j]).belongsTo == pivot1)
        //                    accelerationMatrix[i, j] = -1;
        //            }
        ...
        //                if (((JointMatrixVariableDescriptor) Omeg[i]).belongsTo.localLabels.Contains("pis_conn"))
        //                    accelerationMatrix[i, j] = -1;
        //            }
        //        }
        //    }
        ...
        //    var unknowns_New = new MatrixVariableDescriptor[maxCol - 1];
        //    var z = 0;
        //    for (var i = 0; i < maxCol; i++)
        //    {
        //        if (i != indexno)
        ...
        //                if (unknowns_New[b] is JointMatrixVariableDescriptor &&
        //                    ((JointMatrixVariableDescriptor) unknowns_New[b]).belongsTo == joints[i])
        //                {
