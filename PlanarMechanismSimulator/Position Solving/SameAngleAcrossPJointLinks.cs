...
namespace PMKS.PositionSolving
{
    internal class SameAngleAcrossPJointLinks : NonDyadicObjFunctionTerm
    {
        ...
        public SameAngleAcrossPJointLinks(int varListIndexBlock1, int jointListIndexBlock1, double xBlock1, double yBlock1,
        ...
        {
            get { return blockAngle + blockBaseAngle - (initSlideAngle + slideBaseAngle); }
