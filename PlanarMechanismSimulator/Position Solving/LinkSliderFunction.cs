...
{
    internal class LinkSliderFunction : ILinkFunction
    {
        ...
        public LinkSliderFunction(int varListIndexRef, int jointListIndexRef, double xRef, double yRef, int varListIndexSlide, int jointListIndexSlide, double xSlide, double ySlide,
