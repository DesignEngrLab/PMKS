...
{
    public class optFunctionData : IDictionary<double[], double>
    {
        ...
        public long numEvals { get; set; }
        public double finiteDiffStepSize { get; set; }
        public differentiate findDerivBy { get; set; }

        public optFunctionData(IOptFunction function, IEqualityComparer<double[]> comparer,
