...
namespace OptimizationToolbox
{
    /// <summary>
    /// </summary>
    internal abstract class abstractMeritFunction
    {
        /// <summary>
        ...
        internal double penaltyWeight { get; set; }
        ...
        /// <returns></returns>
        internal abstract double[] calcGradientOfPenalty(double[] point);
        /// <summary>
        /// Calcs the penalty.
        /// </summary>
        /// <param name="point">The point.</param>
        /// <returns></returns>
        internal abstract double calcPenalty(double[] point);
    }
}