...
namespace OptimizationToolbox
{
    ...
    /// </summary>
    internal abstract class abstractSearchDirection
    {
        /// <summary>
        ...
        /// <returns></returns>
        internal abstract double[] find(double[] x, double[] gradf, double f, ref double initAlpha, Boolean reset = false);
        ...
        /// <param name="reset">if set to <c>true</c> [reset].</param>
        /// <returns></returns>
        internal virtual double[] find(double[] x, double[] gradf, double f, Boolean reset = false)
        {
