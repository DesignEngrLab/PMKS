...
namespace PlanarMechanismSimulator
{
    public partial class Simulator : IDependentAnalysis
    {
        ...
        private bool NewPositionFoundInLastPass(List<joint> pivots1)
        {
        ...
        private Boolean findNewPositions(int timeRow, double[,] pivotLengths)
        {
            ...
            var pivots1 = new List<joint>(joints);
        ...
        private bool checkrotatability(List<joint> pivots1)
        {
        ...
        private void FindCircleLineIntersection(joint c1, joint c2, string whatSlider, double length1, List<double> values)
        {
        ...
        private void Find_New_Intersection_points(double length1, double length2, joint c1, joint c2, List<double> values)
        {
            //code obtained from 
        ...
        private void findInputLink_NewPositions(joint qw, List<joint> pivots1, double[,] pivotlengths, int v, int x)
        {
            double x_pos, y_pos;
            double linklength;
        ...
        private Boolean ContainsUnknownPositions(List<joint> pivots1)
        {
